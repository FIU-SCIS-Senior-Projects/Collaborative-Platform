...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=latin1 COMMENT='Application for Domain Mentor';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=latin1 COMMENT='domain mentor picks for domain table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `application_domain_mentor_pick` VALUES (8,7,8,1,'Rejected'),(9,7,9,1,'Rejected'),(10,8,8,3,'Approved'),(11,9,8,6,'Approved'),(12,9,9,8,'Approved'),(13,10,8,6,'Approved'),(14,11,8,10,'Approved'),(15,12,8,10,'Approved'),(16,12,10,10,'Approved'),(17,13,8,10,'Approved'),(18,14,10,10,'Approved');
...
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=latin1 COMMENT='application for personal mentor';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=latin1 COMMENT='picks for the personal mentor from the user table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `application_personal_mentor_pick` VALUES (59,29,1022,'Approved'),(60,30,1023,'Rejected'),(61,31,1022,'Approved'),(62,32,1022,'Approved'),(63,33,1046,'Approved'),(64,34,1046,'Approved');
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=latin1 COMMENT='application for a project mentor';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `application_project_mentor` VALUES (28,10,'Closed','2015-03-16 22:33:52',0,0,0),(29,5,'Closed','2015-04-10 13:37:48',0,0,0),(30,1032,'Closed','2015-07-07 12:28:48',0,0,0);
...
INSERT INTO `application_project_mentor_pick` VALUES (45,28,133,'Rejected'),(46,28,125,'Approved'),(47,29,125,'Approved'),(48,29,121,'Approved'),(49,30,2,'Approved');
...
INSERT INTO `away_mentor` VALUES (1026,'2015-07-28 15:17:46'),(1034,'2015-07-28 15:17:53'),(1035,'2015-07-28 15:18:00');
...
) ENGINE=InnoDB AUTO_INCREMENT=289 DEFAULT CHARSET=utf8 COMMENT='				';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `domain_mentor` VALUES (5,44,1),(6,20,1),(7,20,1),(8,20,1),(10,22,1),(17,10,1),(19,20,1),(999,NULL,1),(1022,40,1),(1026,5,1),(1032,20,1),(1033,20,1),(1034,20,1),(1035,17,1),(1038,3,1),(1040,25,1);
...
INSERT INTO `mentee` VALUES (10,1033,2),(21,17,2),(1002,999,112),(1003,999,133),(1004,999,115),(1005,999,108),(1006,999,134),(1017,999,NULL),(1018,999,NULL),(1019,999,NULL),(1020,999,NULL),(1021,999,110),(1022,1039,2),(1023,999,NULL),(1027,999,1),(1028,999,NULL),(1046,1022,NULL);
...
INSERT INTO `personal_mentor` VALUES (5,'0','0'),(6,'12','0'),(7,'2','3'),(10,'0','0'),(17,'10','2'),(18,'',''),(999,NULL,NULL),(1013,'0','0'),(1022,'0','0'),(1032,'0','0'),(1033,'0','0'),(1039,'0','0'),(1040,'0','0');
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=latin1 COMMENT='this table  matches mentees to their personal mentors';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `project_mentor` VALUES (5,0,0),(6,20,2),(7,NULL,NULL),(10,0,0),(16,24,1),(17,10,1),(18,0,0),(999,NULL,NULL),(1000,2,1),(1012,NULL,NULL),(1016,0,0),(1026,0,0),(1032,0,0);
...
--
-- Table structure for table `report_mentee`
--
...
) ENGINE=InnoDB AUTO_INCREMENT=957 DEFAULT CHARSET=latin1 COMMENT='This table records changes in the tickets such as when is created, when is assigned by user, the status changes, when is escalated, when is commented by owner, escalated, etc';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-07-29  9:08:03
