...
class ApplicationDomainMentorController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('ApplicationDomainMentor');
	...
	{
		$model=new ApplicationDomainMentor('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ApplicationDomainMentor']))
			$model->attributes=$_GET['ApplicationDomainMentor'];
	 ...
	 * @return ApplicationDomainMentor the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=ApplicationDomainMentor::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ApplicationDomainMentor $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='application-domain-mentor-form')
		{
