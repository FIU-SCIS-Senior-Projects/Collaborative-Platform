...
class DomainSuggestionController extends Controller
{
	/**
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete', 'adminview'),
				'users'=>array('admin'),
			),
	...
	{
		$dataProvider=new CActiveDataProvider('DomainSuggestion');
	...
	{
		$model=new DomainSuggestion('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['DomainSuggestion']))
        {
			$model->attributes=$_GET['DomainSuggestion'];
	 ...
	 * @return DomainSuggestion the loaded model
	 ...
	 * @param DomainSuggestion $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='domain-suggestion-form')
		{
