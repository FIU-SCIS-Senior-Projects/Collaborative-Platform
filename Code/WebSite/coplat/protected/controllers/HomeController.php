...
class HomeController extends Controller
{
    ...
    public function actionuserHome()
    {
        ...
        and (status=:pending or status=:reject) Case when event_performed_by_user_id =:id then event_recorded_date end asc, Case when event_performed_by_user_id !=:id then event_recorded_date end desc", array(":id" => $user->id,":pending"=>'pending', ":reject"=>'reject' ));
