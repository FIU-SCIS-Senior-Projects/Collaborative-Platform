...
/*
    ...
    public static function sendTicketAssignedEmailNotification($creator_id, $assign_id, $ticket_domain, $ticket_id)
    {
        ...
        $message = "The user, " . $creator->fname . " " . $creator->lname . ", has created a ticket that has being assigned to you. </h2><br/>Subject: ".$link.".<br/>Description: " .$description. "<br/><br/>The ticket creator stated that this ticket is of ". $priority->description . " priority if no comments or scheduled meetings are made within ". $priority->reassignHours ." the ticket will be reassigned <br/><br/> Please make a comment on the ticket before the ticket is reassigned. Thank You<br/><br/>If you are unable to work on this ticket click here:<br/>".$linkReject;
