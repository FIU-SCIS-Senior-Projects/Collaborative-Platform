...
class University extends CActiveRecord
{
	...
	/* retrieve all university names in the system */
	...
	public static function universityByName($name){
		$uni = University::model()->findBySql("SELECT * from university WHERE name = " + $name);
		return $uni->id;
	}
