...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row" style = "margin-left: 40px">
        ...
        <?php echo $form->dropDownList($model,'subdomain_id', CHtml::listData(Subdomain::model()->findAll(), 'id', 'name'),array('prompt' => 'Select')); ?>
	...
	<div class="row" style = "margin-left: 40px">
		...
		<?php echo $form->numberField($model, 'rate', array('min' => 1, 'max' => 10)); ?>
