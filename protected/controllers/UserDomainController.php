...
class UserDomainController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('UserDomain');
	...
	{
		$model=new UserDomain('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['UserDomain']))
			$model->attributes=$_GET['UserDomain'];
	 ...
	 * @param UserDomain $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='user-domain-form')
		{
