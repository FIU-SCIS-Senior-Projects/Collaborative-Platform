			...
			<td>
				<div id="message-content">		
					...
					<div style="margin-left:50px">
						...
						<?php 
							//echo CHtml::submitButton('Send', array('id'=>'send_button')); ?>
					</div>
