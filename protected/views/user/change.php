<?php
$user =User::model()->findBySql("select * from user where id = $model->id");
...
if($model->isProMentor==1)
{
    ...
    <div class="step" id="first">
        ...
        <div  class="my-box-container7" style="width: auto; float:left;">
            ...
            $projects = Project::model()->findAllBySql("select * from project where  project_mentor_user_id in (999,$model->id)");
            ...
            <div name ="domain" class="container" style="border:2px solid #ccc; width:auto; height: 400px;margin: auto;overflow-y: scroll">
                ...
                <table  style="width:auto;">
                    ...
                    foreach ($domains as $domain)
                    {
                        ...
                        $mySubdomains = UserDomain::model()->findAllBySql("select distinct subdomain_id from user_domain where user_id = $model->id");
                        /*subdomains*/
                        $optionS='';
                        ...
                        foreach($curPSubdomains as $subdomain)
                        {
                          ...
                          foreach($mySubdomains as $mySubdomain)
                          {
                              ...
                              {
                                  $flag=1;
                                  $optionS.='<input style="vertical-align: middle; margin-top: -1px;"  type="checkbox" name ="'.$subdomain->id .'ddmsub" checked/>  '. $subdomain->name .'<br>';
                                    BREAK;
...
if($model->isPerMentor==1)
{
    ...
    <div id="confirmation" class="step">
        ...
        <div  class="my-box-container7" style="width: auto; float:left;">
            ...
            <br>
            <?php
            $mentees = Mentee::model()->findAllBySql("select * from mentee where personal_mentor_user_id in (999, $model->id) or  personal_mentor_user_id is null");
