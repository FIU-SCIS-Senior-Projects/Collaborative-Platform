...
<div class="fullcontent">
    ...
    <div class ="span6" style="margin-top:10px; border: 1px solid #C9E0ED; border-radius: 5px;">
        <br>
    ...
    <div class="span2" style="margin-top: 10px">
        <table>
            ...
            <td><br>
                <?php echo CHtml::submitButton('Submit', array("class" => "btn btn-primary", 'style' => 'width:140px') /*$model->isNewRecord ? 'Create' : 'Save'*/); ?>
